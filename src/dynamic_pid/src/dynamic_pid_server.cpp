...
void DynamicPID::CallBack(dynamic_pid::Dynamic_pidConfig &config, uint32_t level)
{
    ...
    send_msg.data.push_back(config.angle2velo_p);
    send_msg.data.push_back(config.angle2velo_i);
    send_msg.data.push_back(config.angle2velo_d);
    send_msg.data.push_back(config.angle2velo_max);
    send_msg.data.push_back(config.velo2effort_p);
    send_msg.data.push_back(config.velo2effort_i);
    send_msg.data.push_back(config.velo2effort_d);
    send_msg.data.push_back(config.velo2effort_max);
